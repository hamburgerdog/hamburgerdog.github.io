...
![区域融合优化一](../../assets/labelman/区域融合优化一.webp)
...
![区域融合最终优化](../../assets/labelman/区域融合最终优化.webp)
...
![性能基准背景](../../assets/labelman/性能基准背景.webp)

整体优化前，大图单次特征区域的绘制操作在几十毫秒的量级，虽然在总耗时中占比都不是最大的，

![优化前测试结果](../../assets/labelman/优化前测试结果.webp)

整体优化后，单次绘制在个位数的毫秒级响应，性能优化提升明显，且由于使用的是局部的 Mat 对于内存性能而言也是提升很大的。

![优化后测试结果](../../assets/labelman/优化后测试结果.webp)
...
![历史堆栈优化](../../assets/labelman/历史堆栈优化.webp)
